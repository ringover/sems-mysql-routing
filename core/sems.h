...
#define CONFIG_FILE         "/usr/local/sems/conf/sems.conf"
#define MOD_CFG_PATH        "/usr/local/sems/conf/etc/"
#define ANNOUNCE_PATH       "/usr/local/sems/lib/audio"
#define PLUG_IN_PATH        "/usr/local/sems/lib/plug-in"
